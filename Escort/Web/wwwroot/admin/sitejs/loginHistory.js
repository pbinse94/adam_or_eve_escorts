$(function () {
    $.when(loginHistory.ResetStateSaveDataTable()).then(function () {
        loginHistory.List();
    });
});
...
let MemberEmail = [];
let isValidate = true;
let table = $('#data-table_loginHistory');
...
let loginHistory = {
    ...
    List: function () {
        ...
        tbl.BindTable(table, `/AdminUser/LoginHistory`, request, columns, orderColumns);
    },
