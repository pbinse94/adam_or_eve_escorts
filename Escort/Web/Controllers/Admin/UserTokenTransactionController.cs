...
namespace Web.Controllers.Admin
{
    ...
    public class UserTokenTransactionController : AdminBaseController
    {
        ...
        public async Task<IActionResult> ExportSpendingReport()
        {
            ...
            // Ensure 'items.Data' is not null or empty before proceeding
            if (items == null || items.Data == null || !items.Data.Any())
            {
                return new EmptyResult(); // Handle null or empty data gracefully
            }
            ...
            // Pass non-null data to GenerateExcelReport
        ...
        public async Task<IActionResult> ExportUserTransactionReport(UserTokenTransactionRequestModel userTokenTransactionRequestModel)
        {
            ...
            // Pass non-null data to GenerateExcelReport
            return CommonFunctions.GenerateExcelReport(items.Data, columnMapping, "Report", "ReportList.xlsx", dateColumns, null);
        }
        ...
        public async Task<IActionResult> ExportPaymentReport(PaymentReportRequestModel paymentReportRequestModel)
        {
            ...
            // Ensure 'items.Data' is not null before proceeding
            if (items == null || items.Data == null || !items.Data.Any())
            {
                return new EmptyResult(); // Handle null or empty data gracefully
            }
