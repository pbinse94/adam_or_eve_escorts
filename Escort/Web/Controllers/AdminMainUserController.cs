...
namespace Web.Controllers
{
    ...
    public class AdminMainUserController : AdminBaseController
    {
        ...
        public AdminMainUserController(AdminPermissionService adminPermissionService, IManageService manageService, IAccountService accountService, IUserService userService, IFileStorageService fileStorageService)
        {
        ...
        public async Task<ActionResult> ProfileDetail(int? id)
        {
            ...
            return RedirectToAction("Index", "AdminMainUser");
        }
