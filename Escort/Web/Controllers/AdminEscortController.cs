...
namespace Web.Controllers
{
    ...
    public class AdminEscortController : AdminBaseController
    {
        ...
        public AdminEscortController(AdminPermissionService adminPermissionService, IEscortServices escortServices, IAccountService accountService, IProfileService profileService)
        {
