...
namespace Web.Controllers
{
    ...
    public class AdminUserTokenTransactionController : AdminBaseController
    {
        ...
        public AdminUserTokenTransactionController(AdminPermissionService adminPermissionService, IUserService userTokenTransactionServices)
        {
        ...
        public IActionResult Index()
        {
            ...
            if (!canView && _userRole != (int)UserTypes.SuperAdmin) { return RedirectToAction("Index", "ADminDashboard", new { area = "" }); }
        ...
        public async Task<IActionResult> ExportSpendingReport()
        {
            ...
            // Ensure 'items.Data' is not null before passing it to GenerateExcelReport
            return CommonFunctions.GenerateExcelReport(items.Data ?? new List<UserTokenTransactionDto>(), columnMapping, "Report", "ReportList.xlsx", null);
        }
