...
namespace Web.Controllers
{
    ...
    public class AdminAccountController : Controller
    {
        ...
        public AdminAccountController(AdminPermissionService adminPermissionService, IMemoryCache cache, IManageService manageService, IHttpContextAccessor httpContextAccessor, IAccountService accountService)
        {
