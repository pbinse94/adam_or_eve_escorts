...
namespace Web.Controllers
{
    ...
    public class AdminSubscriptionTransactionsController : AdminBaseController
    {
        private readonly ISubscriptionTransactionsService _subscriptionTransactionsService;
        public AdminSubscriptionTransactionsController(ISubscriptionTransactionsService subscriptionTransactionsService)
        {
